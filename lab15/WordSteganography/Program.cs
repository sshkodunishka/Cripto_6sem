...
namespace WordSteganography
{
    class Program
    {
        ...
        //    Document encryptedDocument = new Document("encrypted_file.docx");

        //    // Calculate the number of encrypted bytes based on the number of lines in the document
        //    double linesCount = encryptedDocument.Sections[0].Body.Paragraphs.Count;
        //    int encryptedBytes = (int)Math.Round(linesCount / 8);

        //    // Iterate through the paragraphs and decrypt the data
        //    StringBuilder decryptedData = new StringBuilder();
        //    for (int i = 0; i < encryptedBytes; i++)
        //    {
        //        String paragraphText = encryptedDocument.Sections[0].Body.Paragraphs[i].Runs[0].Text;
        //        decryptedData.Append(paragraphText.EndsWith(" ") ? '1' : '0');
        //    }

        //    // Convert the decrypted binary data back to the original string
        //    string decryptedMessage = BinaryToString(decryptedData.ToString());
        ...
        public static void ColorDecryption()
        {
            ...
            for (int i = 0; i < lines_count; i++)
            {
                ...
                if (document.Sections[0].Body.Paragraphs[i].Runs[0].Font.Color.G == 255)
                {
                    arr += '1';
                }
                else
